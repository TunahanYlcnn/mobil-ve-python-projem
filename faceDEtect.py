...
mevcut_durum = firebase_db.reference("test_write6").get()
kapi_acik_mi = True if mevcut_durum == "door opened" else False
...
while True:
    ...
    # Eğer kimse yoksa ve kapı açıksa süreyi kontrol et
    if not kayitli_kisi_var_mi and kapi_acik_mi == True:
